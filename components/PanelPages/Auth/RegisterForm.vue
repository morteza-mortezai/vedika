...
const { value: fullName, errorMessage: fullNameErr } = useField<string>('fullName');
...
const register = handleReg(async (values) => {
...
<template>
  ...
  <form @submit.prevent="register">
    ...
    <div class="form-control w-full">
      ...
      <input v-model="fullName" name="fullName" type="text" :placeholder="$t('full_name')"
